...
/**
	 ...
	 */
class IMapTests extends ICollectionTests
{
    private var _map(get, never) : IMap;
    ...
    private function get__map() : IMap
    {
    ...
    {
        assertTrue(Std.is(_test.collection.iterator(), IMapIterator));
    }
    ...
    public function test_itemFor_wrongKey() : Void
    {
        ...
        assertTrue(null == _map.itemFor(TestItems.object4Key));
        assertTrue(null == _map.itemFor(null));
        assertTrue(null == _map.itemFor(-1));
    }
    ...
    public function test_itemFor_wrongKey_objectKeys() : Void
    {
        ...
        assertTrue(null == _map.itemFor(TestItems.object4));
        assertTrue(null == _map.itemFor(null));
    }
    ...
    public function test_itemFor_wrongKey_mixedKeys() : Void
    {
        ...
        assertTrue(null == _map.itemFor("null"));
        assertTrue(null == _map.itemFor(2));
        assertTrue(null == _map.itemFor(-2));
        assertTrue(null == _map.itemFor("-2"));
        assertTrue(null == _map.itemFor("false"));
        assertTrue(null == _map.itemFor(false));
        assertTrue(null == _map.itemFor(TestItems.object9));
    }
    ...
    public function test_removeKey_wrongKey() : Void
    {
        ...
        assertTrue(null == _map.removeKey(TestItems.object4Key));
        assertTrue(null == _map.removeKey(null));
    ...
    public function test_removeKey_wrongKey_objectKeys() : Void
    {
        ...
        assertTrue(null == _map.removeKey(TestItems.object4));
        assertTrue(null == _map.removeKey(null));
    ...
    public function test_removeKey_wrongKey_mixedKeys() : Void
    {
        ...
        assertTrue(null == _map.removeKey("null"));
        assertTrue(null == _map.removeKey(2));
        assertTrue(null == _map.removeKey(-2));
        assertTrue(null == _map.removeKey("-2"));
        assertTrue(null == _map.removeKey("false"));
        assertTrue(null == _map.removeKey(false));
        assertTrue(null == _map.removeKey(TestItems.object9));
