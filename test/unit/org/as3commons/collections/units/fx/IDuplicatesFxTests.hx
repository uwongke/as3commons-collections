...
/**
	 ...
	 */
class IDuplicatesFxTests extends AbstractCollectionUnitTestCase
{
    ...
    {
        assertTrue(Std.is(_test.collection, ITestDuplicates));
    ...
    public function test_removeAll() : Void
    {
        ...
        assertTrue(listener.eventReceived);
        var events : Array<Dynamic> = listener.events;
