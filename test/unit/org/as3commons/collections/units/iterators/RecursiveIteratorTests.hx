...
/**
	 ...
	 */
class RecursiveIteratorTests extends AbstractSpecialIteratorUnitTestCase
{
    
    public function new(test : AbstractSpecialIteratorTestCase)
    {
        super(test);
    }
    ...
    public function test_init() : Void
    {
        ...
        assertTrue(Std.is(iterator, IRecursiveIterator));
    }
    ...
    public function test_avoidRecursions() : Void
    {
        ...
        {
            var next : Dynamic = iterator.next();
            result.push(next);
        }
