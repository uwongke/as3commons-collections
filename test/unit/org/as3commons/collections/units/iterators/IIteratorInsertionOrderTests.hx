...
/**
	 ...
	 */
class IIteratorInsertionOrderTests extends AbstractIteratorUnitTestCase
{
    ...
    {
        assertTrue(Std.is(_test.getIterator(), ITestIteratorInsertionOrder));
    }
    ...
    public function test_current_resetAfterAdd() : Void
    {
        ...
        var iterator : ITestIteratorInsertionOrder = try cast(_test.getIterator(), ITestIteratorInsertionOrder) catch(e:Dynamic) null;
