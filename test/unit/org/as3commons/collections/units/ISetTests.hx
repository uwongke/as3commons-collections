...
/**
	 ...
	 */
class ISetTests extends ICollectionTests
{
    private var _set(get, never) : ISet;
    ...
    private function get__set() : ISet
    {
        return try cast(_test.collection, ISet) catch(e:Dynamic) null;
    }
    ...
    {
        assertTrue(Std.is(_test.collection, ISet));
    }
