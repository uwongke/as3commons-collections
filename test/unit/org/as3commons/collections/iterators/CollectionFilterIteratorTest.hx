...
/**
	 ...
	 */
class CollectionFilterIteratorTest extends AbstractSpecialIteratorTestCase
{
    ...
    public function test_previous_withoutHasPrevious() : Void
    {
        ...
        var iterator : ICollectionIterator = try cast(getFilterIterator(), ICollectionIterator) catch(e:Dynamic) null;
        iterator.end();
