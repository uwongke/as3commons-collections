...
/**
	 ...
	 */
class SortedListTest extends AbstractCollectionTestCase
{
    private var _sortedList(get, never) : ISortedList;
    ...
    private function get__sortedList() : ISortedList
    {
        return try cast(collection, ISortedList) catch(e:Dynamic) null;
    }
