...
/**
	 ...
	 */
class ArrayListIteratorTest extends AbstractIteratorTestCase
{
    ...
    {
        return cast((collection), IOrderedList).iterator(index);
    }
    ...
    {
        assertTrue(Std.is(getIterator(), IOrderedListIterator));
    }
    ...
    public function test_index_notResetAfterReplace() : Void
    {
        ...
        var iterator : IOrderedListIterator = try cast(getIterator(), IOrderedListIterator) catch(e:Dynamic) null;
