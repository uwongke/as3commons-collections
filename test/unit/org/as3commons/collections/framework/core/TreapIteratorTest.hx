...
/**
	 ...
	 */
class TreapIteratorTest extends AbstractIteratorTestCase
{
    ...
    {
        cast((collection), TreapMock).clear();
    ...
    {
        return cast((collection), TreapMock).iterator();
    }
    
    override public function toArray() : Array<Dynamic>
    {
        return cast((collection), TreapMock).toArray();
    }
