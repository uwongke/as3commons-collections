...
/**
	 ...
	 */
class LinkedMapFxTest extends LinkedMapTest
{
    private var _orderedMapFx(get, never) : IOrderedMap;
    ...
    private function get__orderedMapFx() : IOrderedMap
    {
    ...
    public function test_iterator_addBefore_eventKey() : Void
    {
        ...
        var iterator : IOrderedMapIterator = try cast(_orderedMapFx.iterator(), IOrderedMapIterator) catch(e:Dynamic) null;
