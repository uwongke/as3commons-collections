...
class LinkedLists {
    ...
    public static function newLinkedList(args : Array<Dynamic> = null) : LinkedList {
        var list : LinkedList = new LinkedList();
        addFromArray(list, args);
        return list;
    }

    public static function addFromArray(list : ILinkedList, source : Array<Dynamic>) : Int {
        if (source == null) {
            return 0;
        }
    ...
    public static function addFromCollection(list : ILinkedList, source : ICollection) : Int {
        if (source == null) {
            return 0;
        }
    ...
    public static function addFromArgs(list : ILinkedList, args : Array<Dynamic> = null) : Int {
    ...
    public static function clone(list : ILinkedList, filter : Function = null) : ILinkedList {
        var clone : ILinkedList = Type.getClass(list);
    ...
    public static function copy(source : ILinkedList, destination : ILinkedList, filter : Function = null) : Int {
